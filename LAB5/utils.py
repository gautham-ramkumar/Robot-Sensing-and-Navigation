...
def load_images(path):
    ...
    images = [cv2.resize(img, (1000,1000)) for img in images]
...
def draw_matches(img1, img2, kp1, kp2, matches, num_matches=100):
    ...
    """
    img_matches = cv2.drawMatches(img1, kp1, img2, kp2, matches[:num_matches], None, matchesThickness=10, flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
